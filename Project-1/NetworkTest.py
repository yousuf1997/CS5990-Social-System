...
originalNetworkOfAmazonRawData = dataReader.readData("[YOUR_PATH]//com-amazon.ungraph.txt", "Amazon")
...
barabasiModelOfAmazonData = networkBuilder.generateBarabasiAlbertNetwork(graph=originalNetworkOfTwitch, K=1000)
